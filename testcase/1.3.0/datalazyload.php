...
-->
<style type="text/css">
    #container{border: 1px solid green;margin-top: 5px;}
    #gap{height: 50px;background-color: red}
    .mod{height: 400px;margin:5px;border: 1px solid red;}
</style>
...
<script type="text/javascript">
    ...
    cajaConfig={//配置下你需要引入的模块名称，最后会被use到
        modules:"openjs/kissy/1.3.0/core,openjs/kissy/1.3.0/datalazyload"
    }
...
<?
$jsurl="testcase/1.3.0/datalazyload.js";//注意路径
